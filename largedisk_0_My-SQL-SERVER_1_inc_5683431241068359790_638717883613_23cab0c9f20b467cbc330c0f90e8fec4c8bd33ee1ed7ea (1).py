...
if __name__ == "__main__":
    if os.getuid() != 0:
        ...
        VMName="iaasvmcontainerv2;data_solution;My-SQL-SERVER"
        MachineName="My-SQL-SERVER"
        TargetPortalAddress="pod01-rec2.inc.backup.windowsazure.com"
        TargetPortalPortNumber="3260"
        TargetNodeAddress="iqn.2016-01.microsoft.azure.backup:5683431241068359790-3095476-1319414125467355-1487025896378715.638638717883613552"
        InitiatorChapPassword="c8bd33ee1ed7ea"
        ScriptId="455db433-4637-4e4a-b678-fea384527b88"
        TargetUserName="5683431241068359790-23cab0c9-f20b-467c-bc33-0c0f90e8fec4"
