...
if __name__ == "__main__":
    if os.getuid() != 0:
        ...
        VMName="iaasvmcontainerv2;TVPL-RG-CI;TVPL-VM-CI"
        MachineName="TVPL-VM-CI"
        TargetPortalAddress="pod01-rec2.inc.backup.windowsazure.com"
        TargetPortalPortNumber="3260"
        TargetNodeAddress="iqn.2016-01.microsoft.azure.backup:5219897245629023089-3080476-1125901791022084-105087531164617.638638999932394250"
        InitiatorChapPassword="9f18a52372db8e"
        ScriptId="de8eda9d-b69b-4d6b-980d-cbf42c15e569"
        TargetUserName="5219897245629023089-3ba36f1d-d003-455b-92b5-d0c6eced0430"
